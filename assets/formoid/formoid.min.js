...
e.error?o.reject(e.error):o.resolve(e.response)}catch(a){o.reject("Incorrect server response.")}}).fail(function(){var t="Error de conexión al servidor. "
t+="onLine"in navigator&&!navigator.onLine?"Sin conexión de internet.":"Verifica tu conexión e intentalo de nuevo.",o.reject(t)}),o)},{Form:function(t){return new i(t)}}}(),a=function(e){if(e.checkValidity)return e.checkValidity()
